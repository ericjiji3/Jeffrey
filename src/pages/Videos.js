  ...
  return(
    <div className="container">
      ...
      <div className="skits text-center">
          <h1 className="video-header text-left ml-5">Short Skits</h1>
        ...
        <div className="stand-up text-center">
          <h1 className="video-header text-left ml-5">Sketches</h1>
          <h2 className="video-header">FHS Promposal (2017)</h2>
          <video src={promposal} className="vid mb-4" controls></video>
